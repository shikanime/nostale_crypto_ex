defmodule NostaleCrypto.Legacy.LoginCrypto do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> NostaleCrypto.Legacy.LoginCrypto.encrypt("fail Hello. This is a basic test")
  ...
  ## Examples
    ...
    iex> NostaleCrypto.Legacy.LoginCrypto.decrypt_pass("2EB6A196E4B60D96A9267E")
    "admin"
    iex> NostaleCrypto.Legacy.LoginCrypto.decrypt_pass("1BE97B527A306B597A2")
    "user"
  """
